...
const cart = computed(() => JSON.parse(usePage().props.cart));
// Compute the total number of products in the cart
            ...
            <div v-if="canLogin" class="flex items-center md:order-2">
                <div class="mr-4">
                    ...
                    <div
                        ...
                        {{ totalCartProduct }}</div>
                    </Link>


                </div>
                <button v-if="auth" type="button"
                ...
                <div v-if="auth"
                    ...
                    id="user-dropdown">
                    <div class="px-4 py-3">
                        <span class="block text-sm text-gray-900 dark:text-white">{{ auth.name }}</span>
